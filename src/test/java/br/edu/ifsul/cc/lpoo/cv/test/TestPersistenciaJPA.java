...
f.setCpf("03223767890");
f.setRG("8276637890");
f.setNumero_celular("549991873456");
f.setNome("lucas");
f.setEndereco("Rua dos pinheiros 479");
f.setComplemento("Proximo ao centro");
f.setCep("0012533");
f.setEmail("lucas@gmail.com");
f.setSenha("12345");
f.setNumero_pis("001234");
f.setNumero_ctps("001234");
ins.persist(f);
//outro
e=new Especie();
e.setId(2);
